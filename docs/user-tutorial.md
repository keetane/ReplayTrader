...
![初期画面](assets/user-tutorial/01-initial-screen.png)
...
![架空サンプル読込後](assets/user-tutorial/02-sample-loaded.png)
...
![日付指定と時間足変更](assets/user-tutorial/03-date-timeframe-picker.png)
...
![信用新規の買い注文後](assets/user-tutorial/04-open-margin-position.png)
...
![信用返済後のマークと確定損益](assets/user-tutorial/05-close-position-and-marker.png)

## 8. テーマを切り替える

右上の「ライト」「ダーク」ボタンで表示テーマを切り替えられます。

![ライトモード](assets/user-tutorial/06-light-mode.png)
