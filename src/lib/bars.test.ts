...
describe("bar helpers", () => {
  ...
  it("filters chart bars from seven available trading dates before the active date", () => {
    const sourceBars = [
      bar("2024-05-08 09:00:00+0900", 50, 50, 50, 50, 10),
      bar("2024-05-09 09:00:00+0900", 60, 60, 60, 60, 10),
      bar("2024-05-10 09:00:00+0900", 70, 70, 70, 70, 10),
      bar("2024-05-13 09:00:00+0900", 80, 80, 80, 80, 10),
      bar("2024-05-14 09:00:00+0900", 90, 90, 90, 90, 10),
      bar("2024-05-15 09:00:00+0900", 100, 100, 100, 100, 10),
      bar("2024-05-16 09:00:00+0900", 110, 110, 110, 110, 10),
      bar("2024-05-17 09:00:00+0900", 120, 120, 120, 120, 10),
    ];

    expect(filterBarsFromDateLookback(sourceBars, "2024-05-17", 7).map((item) => item.datetime)).toEqual([
      "2024-05-08 09:00:00+0900",
      "2024-05-09 09:00:00+0900",
      "2024-05-10 09:00:00+0900",
      "2024-05-13 09:00:00+0900",
      "2024-05-14 09:00:00+0900",
